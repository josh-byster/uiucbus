...
function directToMaps(lat, long, trip, shape, color, vehicle) {
  ...
  <div class="modal-dialog" role="document">
    ...
    if (lat != 0 && long != 0) {
        modalBody.innerHTML =
            `<center><img src="https://maps.googleapis.com/maps/api/staticmap?center=${lat},${long}&size=300x300&maptype=roadmap&markers=color:blue%7Clabel:B%7C${lat},${long}&markers=color:green%7Clabel:GBB%7C${stop_lat},${stop_long}&key=${google_api}"/>`
